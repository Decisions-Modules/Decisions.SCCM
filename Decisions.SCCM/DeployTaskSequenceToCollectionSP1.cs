...
namespace SCCM_2012
{
    [AutoRegisterStep("Deploy Task Sequence To Collection (SP1)", "SCCM Steps", "Task Sequence")]
    [Writable]
    public class SCCMDeployTaskSequenceToCollectionSP1 : SCCMBaseStep, ISyncStep, IDataConsumer, IDataProducer, IDataConsumerMetadataProvider, IDefaultInputMappingStep, INotifyPropertyChanged
    {
        [WritableValue]
        ...
        private const string INPUT_TARGET_AVAILABILITY_OPTION = "Make available to the following:";
        ...
        public ResultData Run(StepStartData data)
        {
            ...
            TaskSequenceTargetOptions tsTargetOptions = (TaskSequenceTargetOptions)data.Data[INPUT_TARGET_AVAILABILITY_OPTION];
            switch (tsTargetOptions)
            {
                case TaskSequenceTargetOptions.OnlyConfigurationManagerClients:
                    break;

                case TaskSequenceTargetOptions.ConfigurationManagerClientsMediaAndPXE:
                    tsFlags.adv_ENABLE_TS_FROM_CD_AND_PXE = true;
                    break;

                case TaskSequenceTargetOptions.OnlyMediaAndPXE:
                    tsFlags.adv_ENABLE_TS_FROM_CD_AND_PXE = true;
                    tsFlags.adv_ENABLE_TS_ONLY_MEDIA_AND_PXE = true;
                    break;

                case TaskSequenceTargetOptions.OnlyMediaAndPXEHidden:
                    tsFlags.adv_ENABLE_TS_FROM_CD_AND_PXE = true;
                    tsFlags.adv_ENABLE_TS_ONLY_MEDIA_AND_PXE = true;
                    tsFlags.adv_ENABLE_TS_ONLY_MEDIA_AND_PXE_HIDDEN = true;
                    break;
            }
        ...
        public DataDescription[] InputData
        {
            get
            {
                ...
                dd.Add(new DataDescription(new DecisionsNativeType(typeof(TaskSequenceTargetOptions)), INPUT_TARGET_AVAILABILITY_OPTION));
        ...
        public DataDescriptionInformation GetDataDescriptionInfo(DataDescription data)
        {
            switch (data.Name)
            {
                ...
                case INPUT_TARGET_AVAILABILITY_OPTION: return new DataDescriptionInformation(new[] { "Inputs", "Deployment Settings" }, 0);
                ...
                return new IInputMapping[]
			               {
                               ...
                               new ConstantInputMapping() { InputDataName = INPUT_TARGET_AVAILABILITY_OPTION, Value = TaskSequenceTargetOptions.OnlyMediaAndPXE },
